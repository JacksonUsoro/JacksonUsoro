<#
.SYNOPSIS
    Remediates finding: User Account Control: Behavior of the elevation prompt for standard users

.DESCRIPTION
    This script checks if the system is configured to automatically deny elevation requests for standard users. 
    If the registry value does not exist or is not configured to the required value (0), 
...
begin {
    ...
    Write-Verbose "Starting check for UAC Policy: Behavior of the elevation prompt for standard users"
}
